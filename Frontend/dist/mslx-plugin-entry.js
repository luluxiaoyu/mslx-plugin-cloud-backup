...
function _e(t) {
  for (var o = 1; o < arguments.length; o++) {
    var r = arguments[o] != null ? arguments[o] : {};
    o % 2 ? De(Object(r), !0).forEach(function(l) {
      N(t, l, r[l]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(r)) : De(Object(r)).forEach(function(l) {
      Object.defineProperty(t, l, Object.getOwnPropertyDescriptor(r, l));
    });
  }
  return t;
...
const $ = /* @__PURE__ */ ct(Ht), D = "/api/plugins/cloud-backup", z = {
  ...
  saveUserProfile: async (t) => await $.post({
    url: `${D}/user/profile`,
    data: t
  }),
  deleteUserProfile: async (t) => (await $.delete({ url: `${D}/user/profile/${t}` }), !0),
  testConnection: async (t) => await $.post({
    url: `${D}/test-connection`,
    data: t
  }),
  // 探测 GFS 状态
  getGfsStatus: async (t) => await $.get({ url: `${D}/instance/gfs-status?instanceId=${t}` }) || { isInstalled: !1, enabled: !1, keepDailyDays: 7, keepWeeklyWeeks: 4, keepMonthlyMonths: 12 },
  // 实例云同步配置
  getInstanceConfig: async (t) => await $.get({ url: `${D}/instance/config?instanceId=${t}` }),
  saveInstanceConfig: async (t, o) => await $.post({
    url: `${D}/instance/config?instanceId=${t}`,
    data: o
  }),
  // 远端文件管理
  getRemoteBackups: async (t) => await $.get({ url: `${D}/instance/remote-backups?instanceId=${t}` }) || [],
  deleteRemoteBackup: async (t, o) => (await $.post({
        ...
        default: e.withCtx(() => [
          e.createElementVNode("div", { class: "py-2 min-h-[380px]" }, [
            f.value ? (e.openBlock(), e.createElementBlock("div", {
              ...
              e.createElementVNode("div", { class: "space-y-4" }, [
  ...
  setup(t) {
    const o = t, r = e.computed(() => o.instanceId || o.serverId || 0), l = e.ref(!1), i = e.ref(!1), k = e.ref(!1), f = e.ref(!1), C = e.ref(""), x = e.ref("all"), m = e.ref([]), p = e.ref({
      ...
      const b = c.tier === "daily" ? "日备份" : c.tier === "weekly" ? "周备份" : c.tier === "monthly" ? "月备份" : "常规备份", E = V.DialogPlugin.confirm({
        ...
        onConfirm: async () => {
          E.hide();
          try {
            await z.deleteRemoteBackup(r.value, c.fullPath), V.MessagePlugin.success("远端备份已删除"), await _();
          } catch (X) {
    ...
    return (c, b) => {
      ...
      return e.openBlock(), e.createElementBlock("div", { class: "flex flex-col mx-auto w-full pb-8" }, [
        ...
        e.createElementVNode("div", { class: "flex flex-col" }, [
          e.createElementVNode("div", { class: "flex flex-col md:flex-row md:items-start justify-between p-3 md:p-4 border-b border-dashed border-zinc-100 dark:border-zinc-800/60 hover:bg-zinc-50/50 dark:hover:bg-zinc-800/20 transition-colors rounded-xl" }, [
            e.createElementVNode("div", { class: "flex-1 pr-0 md:pr-8 mb-3 md:mb-0 min-w-[200px]" }, [
              e.createElementVNode("div", { class: "text-sm font-medium text-[var(--td-text-color-primary)] leading-snug" }, "云端自动同步"),
          ...
          n.value.enabled ? (e.openBlock(), e.createElementBlock(e.Fragment, { key: 0 }, [
            ...
            e.createElementVNode("div", { class: "flex flex-col md:flex-row md:items-start justify-between p-3 md:p-4 border-b border-dashed border-zinc-100 dark:border-zinc-800/60 hover:bg-zinc-50/50 dark:hover:bg-zinc-800/20 transition-colors rounded-xl" }, [
              e.createElementVNode("div", { class: "flex-1 pr-0 md:pr-8 mb-3 md:mb-0 min-w-[200px]" }, [
                e.createElementVNode("div", { class: "text-sm font-medium text-[var(--td-text-color-primary)] leading-snug" }, "远端存储路径模板"),
            ...
            p.value.isInstalled ? (e.openBlock(), e.createElementBlock("div", {
              key: 0,
              ...
              e.createElementVNode("div", { class: "flex-1 pr-0 md:pr-8 mb-3 md:mb-0 min-w-[200px]" }, [
                e.createElementVNode("div", { class: "text-sm font-medium text-[var(--td-text-color-primary)] leading-snug flex items-center gap-1.5" }, [
                  e.createVNode(e.unref(Dt), { class: "text-[var(--color-primary)]" }),
            ...
            p.value.isInstalled && n.value.syncMode !== "RegularOnly" ? (e.openBlock(), e.createElementBlock("div", {
              ...
              e.createElementVNode("div", { class: "flex flex-col md:flex-row md:items-center justify-between mb-3" }, [
                e.createElementVNode("div", null, [
                  e.createElementVNode("div", { class: "text-sm font-medium text-[var(--td-text-color-primary)] leading-snug" }, " 远端 GFS 归档保留策略 "),
                  e.createElementVNode("div", { class: "text-xs text-[var(--td-text-color-secondary)] mt-1 leading-relaxed" }, [
                    e.createTextVNode(" 归档保存在 "),
                    e.createElementVNode("code", null, "gfs-archives/{daily,weekly,monthly}"),
                    e.createTextVNode("，可独立或跟随本地 GFS 策略执行滚动清理。 ")
                  ])
                ]),
              ...
              e.createElementVNode("div", { class: "grid grid-cols-1 md:grid-cols-3 gap-3 my-2" }, [
                e.createElementVNode("div", { class: "p-3.5 rounded-xl border border-zinc-200/70 dark:border-zinc-700/60 bg-white/60 dark:bg-zinc-800/40 flex flex-col justify-between" }, [
                  e.createElementVNode("div", null, [
                    e.createElementVNode("div", { class: "flex items-center justify-between mb-1.5" }, [
                      e.createElementVNode("span", { class: "text-xs font-bold text-[var(--color-primary)] flex items-center gap-1.5" }, [
                    ...
                    e.createElementVNode("div", { class: "text-[11px] text-[var(--td-text-color-secondary)] leading-relaxed mb-3" }, " 每天保存 1 份快照，超出设定份数后自动删除最旧快照。 ")
                  ]),
                ...
                e.createElementVNode("div", { class: "p-3.5 rounded-xl border border-zinc-200/70 dark:border-zinc-700/60 bg-white/60 dark:bg-zinc-800/40 flex flex-col justify-between" }, [
                  e.createElementVNode("div", null, [
                    e.createElementVNode("div", { class: "flex items-center justify-between mb-1.5" }, [
                      e.createElementVNode("span", { class: "text-xs font-bold text-emerald-600 dark:text-emerald-400 flex items-center gap-1.5" }, [
                        e.createVNode(e.unref(Y)),
                    ...
                    e.createElementVNode("div", { class: "text-[11px] text-[var(--td-text-color-secondary)] leading-relaxed mb-3" }, " 每周保存 1 份快照，超出设定份数后自动删除最旧快照。 ")
                  ]),
                  e.createElementVNode("div", { class: "flex items-center justify-between pt-2 border-t border-zinc-100 dark:border-zinc-700/40" }, [
                    e.createElementVNode("span", { class: "text-xs text-zinc-600 dark:text-zinc-300" }, "云端保留上限"),
                    e.createElementVNode("div", { class: "w-[120px]" }, [
                ...
                e.createElementVNode("div", { class: "p-3.5 rounded-xl border border-zinc-200/70 dark:border-zinc-700/60 bg-white/60 dark:bg-zinc-800/40 flex flex-col justify-between" }, [
                  e.createElementVNode("div", null, [
                    e.createElementVNode("div", { class: "flex items-center justify-between mb-1.5" }, [
                      e.createElementVNode("span", { class: "text-xs font-bold text-amber-600 dark:text-amber-400 flex items-center gap-1.5" }, [
                        e.createVNode(e.unref(Y)),
                    ...
                    e.createElementVNode("div", { class: "text-[11px] text-[var(--td-text-color-secondary)] leading-relaxed mb-3" }, " 每月保存 1 份快照，超出设定份数后自动删除最旧快照。 ")
                  ]),
                  e.createElementVNode("div", { class: "flex items-center justify-between pt-2 border-t border-zinc-100 dark:border-zinc-700/40" }, [
                    e.createElementVNode("span", { class: "text-xs text-zinc-600 dark:text-zinc-300" }, "云端保留上限"),
                    e.createElementVNode("div", { class: "w-[120px]" }, [
            ...
            n.value.syncMode !== "GfsOnly" ? (e.openBlock(), e.createElementBlock(e.Fragment, { key: 2 }, [
              e.createElementVNode("div", { class: "flex flex-col md:flex-row md:items-start justify-between p-3 md:p-4 border-b border-dashed border-zinc-100 dark:border-zinc-800/60 hover:bg-zinc-50/50 dark:hover:bg-zinc-800/20 transition-colors rounded-xl" }, [
                e.createElementVNode("div", { class: "flex-1 pr-0 md:pr-8 mb-3 md:mb-0 min-w-[200px]" }, [
                  ...
                  e.createElementVNode("div", { class: "text-xs text-[var(--td-text-color-secondary)] mt-1 leading-relaxed" }, " 云端常规备份的最大保留份数，超出后自动滚动清理最早的历史备份（设为 0 表示不自动清理） ")
                ]),
              ...
              e.createElementVNode("div", { class: "flex flex-col md:flex-row md:items-start justify-between p-3 md:p-4 border-b border-dashed border-zinc-100 dark:border-zinc-800/60 hover:bg-zinc-50/50 dark:hover:bg-zinc-800/20 transition-colors rounded-xl" }, [
                ...
                e.createElementVNode("div", { class: "w-full md:w-[380px] shrink-0 flex flex-wrap items-center justify-start md:justify-end gap-2" }, [
                  ...
                  g.value === "keepN" ? (e.openBlock(), e.createBlock(T, {
                    ...
                    suffix: "份",
                    class: "!w-24"
                  }, null, 8, ["modelValue"])) : e.createCommentVNode("", !0)
                ])
              ])
        ...
        e.createElementVNode("div", { class: "flex items-center gap-2 mt-8 mb-4 pb-2 border-b border-zinc-200/60 dark:border-zinc-700/60" }, [
          e.createElementVNode("div", { class: "w-1 h-4 bg-[var(--color-primary)] rounded-full" }),
          e.createElementVNode("h2", { class: "text-base font-bold text-[var(--td-text-color-primary)] m-0" }, "远端备份管理")
        ]),
        e.createElementVNode("div", { class: "flex flex-col md:flex-row md:justify-between md:items-center py-2 pr-0 md:pr-2 gap-3" }, [
          e.createElementVNode("div", { class: "flex-1 min-w-[200px]" }, [
        ...
        e.createElementVNode("div", { class: "mt-2 border border-zinc-200/60 dark:border-zinc-700/60 rounded-xl overflow-hidden shadow-sm bg-white/50 dark:bg-zinc-900/20" }, [
          e.createVNode(at, {
            ...
            empty: e.withCtx(() => [
              e.createElementVNode("div", { class: "p-8 text-center text-sm font-medium text-[var(--td-text-color-secondary)]" }, [
                C.value ? (e.openBlock(), e.createElementBlock("span", { key: 0 }, "未找到匹配的云端备份文件")) : (e.openBlock(), e.createElementBlock("span", { key: 1 }, "云端目标目录下暂无对应备份文件，或尚未绑定有效策略"))
              ])
            ]),
            _: 1
          }, 8, ["data", "loading"])
